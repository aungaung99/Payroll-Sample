...
namespace Payroll.Data
{
    public partial class PayrollContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=.;Database=Payroll;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Attendance>(entity =>
            {
                ...
                entity.Property(e => e.AttendId).HasMaxLength(20);
                ...
                entity.Property(e => e.LateMinute).HasColumnName("Late_Minute");

                entity.Property(e => e.TotalWorkingHour).HasColumnName("Total_Working_Hour");
            });
